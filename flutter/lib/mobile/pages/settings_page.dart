...
const url = 'https://pluxid.duckdns.org/';
      ...
      enhancementsTiles.insert(
          ...
          SettingsTile.switchTile(
              ...
              title: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(translate('Keep ZoranderDesk background service')),
        ...
        SettingsSection(
          ...
          tiles: [
            ...
            SettingsTile(
              ...
              onPressed: (context) =>
                  launchUrlString('https://pluxid.duckdns.org/privacy.html'),
...
void showAbout(OverlayDialogManager dialogManager) {
  dialogManager.show((setState, close, context) {
    return CustomAlertDialog(
      title: Text(translate('About ZoranderDesk')),
