...
class FfiModel with ChangeNotifier {
  ...
  handlePlatformAdditions(
    ...
    if (updateData.isEmpty) {
      _pi.platformAdditions.remove(kPlatformAdditionsZoranderDeskVirtualDisplays);
      ...
      try {
        ...
        if (!updateJson
            .containsKey(kPlatformAdditionsZoranderDeskVirtualDisplays)) {
          _pi.platformAdditions
              .remove(kPlatformAdditionsZoranderDeskVirtualDisplays);
        }
...
class PeerInfo with ChangeNotifier {
  ...
  List<int> get ZoranderDeskVirtualDisplays => List<int>.from(
      platformAdditions[kPlatformAdditionsZoranderDeskVirtualDisplays] ?? []);
