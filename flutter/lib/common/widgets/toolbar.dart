...
bool showVirtualDisplayMenu(FFI ffi) {
  ...
  if (ffi.ffiModel.pi.isZoranderDeskIdd || ffi.ffiModel.pi.isAmyuniIdd) {
    return true;
  }
  return false;
}
...
List<Widget> getVirtualDisplayMenuChildren(
  ...
  if (pi.isZoranderDeskIdd) {
    final virtualDisplays = ffi.ffiModel.pi.ZoranderDeskVirtualDisplays;
